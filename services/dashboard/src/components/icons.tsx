...
export function IconAgents({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M6 13c0-1.5 1-3 3-3h6c2 0 3 1.5 3 3" />
    </svg>
  );
}
...
export function IconReviews({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconStatusIdle({ size = 10, className }: IconProps) {
  return <circle cx={size / 2} cy={size / 2} r={size / 2 - 1} fill="#22c55e" width={size} height={size} className={className} />;
}

export function IconStatusBusy({ size = 10, className }: IconProps) {
  return <circle cx={size / 2} cy={size / 2} r={size / 2 - 1} fill="#eab308" width={size} height={size} className={className} />;
}

export function IconStatusError({ size = 10, className }: IconProps) {
  return <circle cx={size / 2} cy={size / 2} r={size / 2 - 1} fill="#ef4444" width={size} height={size} className={className} />;
}

export function IconStatusOffline({ size = 10, className }: IconProps) {
  return <circle cx={size / 2} cy={size / 2} r={size / 2 - 1} fill="#64748b" width={size} height={size} className={className} />;
}

export function IconHealth({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconQrCode({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconGitPullRequest({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
